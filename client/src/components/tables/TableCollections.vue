      ...
      <div class="w-full relative lg:pt-6">
        <div class="flex flex-col">
          ...
          >
            ...
            >
              <div
                class="w-[99%] lmax:w-full lmax:border lmax:overflow-hidden lmax:dark:border-darkTheme-border flex lmax:flex-col flex-row justify-start lmax:p-5 sf:p-4 lmax:gap-5 py-1 pl-8 pr-2.5 rounded-2xl hover:bg-gray-50 dark:hover:bg-darkTheme-200 cursor-pointer lg:mx-auto my-1.5"
              >
                <router-link
                  :to="{
                ...
                <div class="relative w-5/12 lmax:w-full overflow-hidden">
                  ...
                  >
                    <div v-show="showTableNavigationButton" class="absolute h-full flex right-0 z-10 items-center">
                      <span
                    ...
                    <div v-show="showTableNavigationButton" class="absolute h-full flex left-0 z-10 items-center">
                      <div
